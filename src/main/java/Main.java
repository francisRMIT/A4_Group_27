public class Main {
    public static void main(String[] args) {
        ...
        boolean condition = p1.addPerson("56s_ad&fAB", "John", "Doe", "32|Highland Street|Melbourne|Victoria|Australia",
                "27-02-2005");
        ...
        // true)
        if (condition) {
            boolean updated = p1.updatePersonalDetails("76s_ad&fAB", "John", "Doe",
        ...
        // NOTE: With the current config above, everything should pass. This should be
